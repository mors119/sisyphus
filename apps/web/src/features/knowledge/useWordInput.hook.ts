...
export function useWordInput(): WordInputWorkspace {
  ...
  const expansionSteps = useMemo<ProgressListItem[]>(
    () => [
      {
        id: 'analyze',
        title: t('knowledge.expansion.steps.analyze'),
        state: 'active',
      },
      {
        id: 'generate',
        title: t('knowledge.expansion.steps.generate'),
        state: 'pending',
      },
      {
        id: 'review',
        title: t('knowledge.expansion.steps.review'),
        state: 'pending',
      },
    ],
    [t],
